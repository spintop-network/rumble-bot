  ...
  const registerEmbed = new EmbedBuilder()
    ...
    .setDescription(
      'Hello, pilots. It’s me, BITS. Long time no see. \n' +
        ...
        '\n' +
        'When you register to be a pilot by pressing the “Register” button, you’ll be given the “Pilot” role. With your new assigned role, you are officially ready to kickstart your journey as a Cobot pilot! You will be ready, but the event starts on the 9th of August, Wednesday, so you’ll have to wait a little while. Registrations will conclude on the 9th of August, which means no one can register after the 9th of August. After completing your registration process by pressing the “Register” button, visit https://discord.com/channels/893489228502167615/1131860456097714218 channel to learn more about Spintop’s Cobot Rumble!\n' +
        '\n' +
