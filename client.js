  ...
  const registerEmbed = new EmbedBuilder()
    ...
    .setDescription(
      'Hello, pilots. It’s me, BITS. Long time no see. \n' +
        ...
        '\n' +
        'When you register to be a pilot by pressing the “Register” button, you’ll be enrolled in the roster and will enter your BSC wallet address. Your rewards will be sent to this wallet address, so giving an actual and working BSC wallet address is essential. After filling in your BSC wallet address info, you are officially ready to kickstart your journey as a Cobot pilot! You will be ready, but the event starts on the 9th of August, Wednesday, so you’ll have to wait a little while. Registrations will conclude on the 9th of August, which means no one can register after the 9th of August. After completing your registration process by pressing the “Register” button, and filling in your BSC wallet address, visit https://discord.com/channels/893489228502167615/1131860456097714218 channel to learn more about Spintop’s Cobot Rumble!\n' +
        '\n' +
